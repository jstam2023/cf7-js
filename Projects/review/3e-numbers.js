...
let roundResult = Math.round(num1 / num2)   //rounds up for .5 and upwards, rounds down otherwise

// Το modulo  διατηρεί το πρόσημο του Διαιρετέου
let modResult = num1 % num2;        // JS & Java remaining part of a division (modulo keeps the remainder)
